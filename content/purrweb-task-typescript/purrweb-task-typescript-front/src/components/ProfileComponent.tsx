  ...
  return (
    <>
      <div className="profile-page__info d-flex flex-column">
        <div className="d-flex align-items-center flex-wrap page__info-header">
          <h1 className='me-4'>Мой профиль</h1>
          <Link to={'/redact_profile'}>
            <div className="d-flex align-items-center ">
              <svg className="me-1" width="1.7vh" height="18.36px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="profile-page__productivity">
        <div className="d-flex flex-wrap flex-column">
          <h2>Ваша продуктивность выросла!</h2>
          <span className="mt-1 mb-3">За прошлую неделю вы выполнили 12 задач</span>
          <div className="button blue_button w-80">Подробнее</div>
        </div>
        <div>
